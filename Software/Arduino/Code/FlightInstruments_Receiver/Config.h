...
#define MAG_OFFSET_X    10.5555f
#define MAG_OFFSET_Y    -2.3537f
#define MAG_OFFSET_Z    -29.8582f

// Soft iron scales (adimensional)
#define MAG_SCALE_X     1.0277f
#define MAG_SCALE_Y     0.9899f
#define MAG_SCALE_Z     0.9849f
...
#define HEADING_BODY_OFFSET_DEG    0.0f
